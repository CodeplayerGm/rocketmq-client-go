...
func (m *MockRemotingClient) ShutDown(ctx context.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ShutDown", ctx)
}

// ShutDown indicates an expected call of ShutDown.
func (mr *MockRemotingClientMockRecorder) ShutDown(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ShutDown", reflect.TypeOf((*MockRemotingClient)(nil).ShutDown), ctx)
}
